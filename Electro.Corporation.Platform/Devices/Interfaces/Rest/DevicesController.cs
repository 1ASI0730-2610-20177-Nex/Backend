    ...
    ProblemDetailsFactory problemDetailsFactory) : ControllerBase
{
    ...
    public async Task<IActionResult> GetAllDevices([FromQuery] int? spaceId, CancellationToken cancellationToken)
    {
        var devices = await deviceQueryService.Handle(new GetAllDevicesQuery(spaceId), cancellationToken);
