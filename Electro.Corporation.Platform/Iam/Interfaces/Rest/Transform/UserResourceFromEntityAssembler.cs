using Electro.Corporation.Platform.Iam.Domain.Model.Aggregates;
using Electro.Corporation.Platform.Iam.Interfaces.Rest.Resources;

// Added for ArgumentNullException

namespace Electro.Corporation.Platform.Iam.Interfaces.Rest.Transform;
